...
4-Open DB Reborn. The main window will show in the screen.
  
  ![alt text][app_window]

5-Select the ".json" file (must be in the same folder
  of YOUR_FILE_TEXTURES). Click in the three dots button, on the right side of the section.
...
8-Copy “YOUR_FILE.spinejson” and the "YOUR_FILE_TEXTURES" folder
